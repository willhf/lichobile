...
export function clockSettingsView(
        ...
        <div key="simpleSettings" className="clockSettingParameters">
          <div className="select_input">
            {formWidgets.renderSelect(
              'Time',
              'time',
              clockSettings.availableTimes,
              clockSettings.simple.time,
              false,
              onChange
            )}
          </div>
        ...
        <div key="incrementSettings" className="clockSettingParameters">
          ...
          <div className="select_input">
            {formWidgets.renderSelect(
              'Increment',
              'increment',
              clockSettings.availableIncrements.map(utils.tupleOf),
              clockSettings.increment.increment,
              false,
              onChange
            )}
          </div>
          ...
          <div className="handicapRow">
            ...
            <div className="select_input inline handicapRowMember">
              {formWidgets.renderSelect(
                ...
                'topTime',
                clockSettings.availableTimes,
                clockSettings.handicapInc.topTime,
                false,
                onChange
              )}
            </div>
            <div className="select_input inline handicapRowMember">
              {formWidgets.renderSelect(
                ...
                'topIncrement',
                clockSettings.availableIncrements.map(utils.tupleOf),
                clockSettings.handicapInc.topIncrement,
                false,
                onChange
              )}
            </div>
          ...
          <div className="handicapRow">
            ...
            <div className="select_input inline handicapRowMember">
              {formWidgets.renderSelect(
                ...
                'bottomTime',
                clockSettings.availableTimes,
                clockSettings.handicapInc.bottomTime,
                false,
                onChange
              )}
            </div>
            <div className="select_input inline handicapRowMember">
              {formWidgets.renderSelect(
                ...
                'bottomIncrement',
                clockSettings.availableIncrements.map(utils.tupleOf),
                clockSettings.handicapInc.bottomIncrement,
                false,
                onChange
              )}
            </div>
        ...
        <div key="bronsteinSettings" className="clockSettingParameters">
          ...
          <div className="select_input">
            {formWidgets.renderSelect(
              ...
              'increment',
              clockSettings.availableIncrements.map(utils.tupleOf),
              clockSettings.bronstein.increment,
              false,
              onChange
            )}
          </div>
    ...
    stage() {
      return (
        <div key="hourglassSettings" className="clockSettingParameters">
          {clockSettings.stage
            .stages()
            .map(renderStage.bind(undefined, clockSettings, onChange))}
          <div className="select_input">
            {formWidgets.renderSelect(
              'Increment',
              'increment',
              clockSettings.availableIncrements.map(utils.tupleOf),
              clockSettings.stage.increment,
              false,
              onChange
            )}
          </div>
...
function renderStage(
  ...
  return (
    <div className="stageRow">
      ...
      <div
        className={
          'select_input inline stage stageRowMember' +
          (index === clockSettings.stage.stages().length - 1
            ? ' lastStage'
            : '')
        }
      >
        {formWidgets.renderSelect(
          'Moves',
          'moves',
          clockSettings.availableMoves.map(utils.tupleOf),
          moves,
          false,
          onChange
        )}
      ...
      <div
        className={
          'stageRowMember addSubtractStage' +
          (index === clockSettings.stage.stages().length - 1
            ? ' lastStage'
            : '')
        }
      >
        <span
          className={'fa fa-plus-square-o' + (hidePlus ? ' hiddenButton' : '')}
          oncreate={helper.ontap(() => addStage(clockSettings.stage.stages))}
        />{' '}
        <span
          className={
            'fa fa-minus-square-o' + (hideMinus ? ' hiddenButton' : '')
          }
          oncreate={helper.ontap(() => removeStage(clockSettings.stage.stages))}
        />
      </div>
    </div>
  )
