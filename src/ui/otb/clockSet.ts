...
export default {
  ...
  simple: (onFlag: (color: Color) => void) =>
    SimpleClock(
      Number(settings.otb.clock.simple.time()) * MINUTE_MILLIS,
      onFlag
    ),

  increment: (onFlag: (color: Color) => void) =>
    IncrementClock(
  ...
  handicapInc: (onFlag: (color: Color) => void) =>
    HandicapIncClock(
  ...
  bronstein: (onFlag: (color: Color) => void) =>
    BronsteinClock(
  ...
  hourglass: (onFlag: (color: Color) => void) =>
    HourglassClock(
  ...
  stage: (onFlag: (color: Color) => void) =>
    StageClock(
      settings.otb.clock.stage
        .stages()
