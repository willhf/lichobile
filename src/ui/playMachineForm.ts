...
export default {
  ...
  view() {
    ...
    return popupWidget('game_form_popup', undefined, form, isOpen, close)
  }
}
              ...
              h(
                'div.setupMiniBoardWrapper',
                {
                  ...
                  oncreate: helper.ontap(() => {
                    ...
                    if (fromPositionFen) {
                      router.set(
                        `/editor/${encodeURIComponent(fromPositionFen)}`
                      )
                    }
                  })
                },
    ...
    h(
      ...
      [
        formWidgets.renderSelect(
          'level',
          'ailevel',
          ['1', '2', '3', '4', '5', '6', '7', '8'].map(utils.tupleOf),
          settingsObj.level
        )
      ]
    )
  ...
  return h(
    ...
    [
      ...
      h('div.popupActionWrapper', [
        h(
          'button[data-icon=E][type=submit].popupAction',
