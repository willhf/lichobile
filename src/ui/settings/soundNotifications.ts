  ...
  return h('ul.native_scroller.page.settings_list.game', [
    ...
    h(
      ...
      formWidgets.renderCheckbox(
        ...
        'vibrate',
        settings.general.vibrateOnGameEvents,
        vibrate.onSettingChange
      )
    ),
    h(
      'li.list_item',
      formWidgets.renderCheckbox(
        i18n('notifications'),
        'notifications',
        settings.general.notifications.allow,
        isOn => {
...
export default {
  ...
  view() {
    const header = () =>
      dropShadowHeader(null, backButton(i18n('soundAndNotifications')))
